...
score = GymAdapter.evaluate_genome_cartpole(genome, 1)
...
{evolved_pop, stats} = GymAdapter.evolve_on_cartpole(population, 5, 3, true)
...
GymAdapter.evaluate_genome_cartpole(best_genome, 1, true)
